<?php
/**
 * Affichage des adresses dans les commandes
 *
 * @package WPShop
 * @subpackage Customer
 */
...
?>
		<li class="<?php echo esc_attr( $class ); ?> wps-bloc-loader wps_address_li">
			<span><input type="radio" class="wps_select_address" value="<?php echo esc_attr( $address_id ); ?>" name="<?php echo esc_attr( $type ); ?>_address_id" id="wps_select_address_<?php echo esc_attr( $address_id ); ?>" <?php echo $checked; ?> /></span>
			<span><strong><?php echo ( ! empty( $customer_name ) ? $customer_name : '' ); ?></strong></span>
			<span><?php echo esc_html( $name_to_display ); ?></span>
