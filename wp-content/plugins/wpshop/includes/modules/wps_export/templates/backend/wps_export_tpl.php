...
<div class="wps-row wps-gridwrapper2-padded" style="display:none" id="wps_export_minp_group">
...
<a id="wps_export_download_btn" style="display:none" class="wps-bton-first-mini-rounded"><?php _e('Download', 'wps_export'); ?></a>
