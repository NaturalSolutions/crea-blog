...
/*	Define upload dir	*/
 $wp_upload_dir = wp_upload_dir();
  DEFINE( 'WPSHOP_UPLOAD_DIR', $wp_upload_dir['basedir'] . '/' );
	DEFINE( 'WPSHOP_UPLOAD_URL', $wp_upload_dir['baseurl'] . '/' );
	DEFINE( 'WPSHOP_WP_UPLOAD_DIR', $wp_upload_dir['basedir'] . '/' );
 ...
 DEFINE( 'WPSHOP_NEWTYPE_IDENTIFIER_CUSTOMERS_GROUP', 'wps_customer_group' );
  ...
  DEFINE( 'WPSHOP_NEWTYPE_IDENTIFIER_CATEGORIES', 'wpshop_product_category' );
   DEFINE( 'WPSHOP_PRODUCT_RELATED_PRODUCTS', '_' . WPSHOP_NEWTYPE_IDENTIFIER_PRODUCT . '_related_products' );
	DEFINE( 'WPSHOP_PRODUCT_PROVIDER', '_' . WPSHOP_NEWTYPE_IDENTIFIER_PRODUCT . '_provider' );
  ...
  DEFINE( 'WPSHOP_DEFAULT_CUSTOM_TYPES', serialize( array( WPSHOP_NEWTYPE_IDENTIFIER_PRODUCT, WPSHOP_NEWTYPE_IDENTIFIER_CUSTOMERS, WPSHOP_NEWTYPE_IDENTIFIER_ADDRESS ) ) );
...
/*
 ...
 $wpshop_display_option = get_option( 'wpshop_display_option' );
	DEFINE( 'WPSHOP_DISPLAY_GRID_ELEMENT_NUMBER_PER_LINE', (isset( $wpshop_display_option['wpshop_display_grid_element_number'] ) && ($wpshop_display_option['wpshop_display_grid_element_number'] >= 1) ? $wpshop_display_option['wpshop_display_grid_element_number'] : 1) );
	DEFINE( 'WPSHOP_DISPLAY_GRID_ELEMENT_NUMBER_PER_LINE_MIN_RANGE', 1 );
 ...
 /*	ADMIN DISPLAY	*/
 $attribute_page_layout_types = array(
	 'tab' => __( 'Tabs', 'wpshop' ),
	 'separated_bloc' => __( 'Separated bloc', 'wpshop' ),
 );
 ...
 DEFINE( 'WPSHOP_ATTRIBUTE_EDITION_PAGE_LAYOUT', ( ! empty( $wpshop_admin_display_option['wpshop_admin_attr_layout'] )?$wpshop_admin_display_option['wpshop_admin_attr_layout']:'tab') );
	$product_page_layout_types = array(
		'movable-tab' => __( 'Separated box in product page', 'wpshop' ),
		'fixed-tab' => __( 'A tab in product data box "Product data"', 'wpshop' ),
		'each-box' => __( 'In each attribute group section "Product data"', 'wpshop' ),
	);
	...
	DEFINE( 'WPSHOP_VAT_ON_SHIPPING_COST', apply_filters( 'wps_change_shipping_vat', 20 ) );
	...
	DEFINE( 'WPSHOP_ADDONS_STATES_CLASS', serialize( array(
		true => 'wpshop_addons_state wpshop_addons_state_activated',
		false => 'wpshop_addons_state wpshop_addons_state_deactivated',
	) ) );
	DEFINE( 'WPSHOP_ADDONS_LIST', serialize( array(
		'WPSHOP_ADDONS_QUOTATION' => array( __( 'Quotation','wpshop' ), '48', 'per_site', 'quotation_allowed', 'WPSHOP_NEW_QUOTATION_ADMIN_MESSAGE' ),
		'WPSHOP_ADDONS_PAYMENT_GATEWAY_CB_CIC' => array( __( 'Payment gateway CIC','wpshop' ), '32', 'per_site', '' ),/* , 'WPSHOP_ADDONS_PRICE_PER_GROUP' => array(__('Price per user group','wpshop'), '13', 'free') */
	) ) );
	...
	DEFINE( 'WPSHOP_ATTR_SELECT_TYPE', serialize( array(
		'custom' => 'custom_data',
		'internal' => 'internal_data',
	) ) );
	DEFINE( 'WPSHOP_ATTR_SELECT_TYPE_TOGGLED', serialize( array(
		'custom' => 'internal_data',
		'internal' => 'custom_data',
	) ) );
	...
	$attribute_options_group = array(
		__( 'Attribute unit', 'wpshop' ) => array( 'is_requiring_unit', '_unit_group_id', '_default_unit' ),
		__( 'Frontend option', 'wpshop' ) => array( 'is_visible_in_front', 'is_visible_in_front_listing', 'is_used_for_sort_by', 'is_visible_in_advanced_search', 'is_searchable', '_display_informations_about_value' ),
		__( 'Variations', 'wpshop' ) => array( 'is_user_defined', 'is_used_in_variation', 'is_used_for_variation', 'frontend_input' ),
	);
	...
	$customer_adress_information_field = array(
		'civility' => __( 'Civility', 'wpshop' ),
		'first_name' => __( 'First name', 'wpshop' ),
		'last_name' => __( 'Last name', 'wpshop' ),
		'email' => __( 'Email adress', 'wpshop' ),
		'phone' => __( 'Phone number', 'wpshop' ),
		'company' => __( 'Company', 'wpshop' ),
		'address' => __( 'Adresse', 'wpshop' ),
		'postcode' => __( 'Postcode', 'wpshop' ),
		'city' => __( 'City', 'wpshop' ),
