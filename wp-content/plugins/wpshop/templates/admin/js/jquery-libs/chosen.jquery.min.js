...
(function($) {
  ...
  return $.fn.ajaxChosen = function(settings, callback) {
    ...
    defaultOptions = {
      ...
      afterTypeDelay: 500,
      jsonTermKey: "term",
      textTyping: "Keep typing...",
      textSearching: "Looking for"
    };
    select = this;
    chosenXhr = null;
    options = $.extend({}, defaultOptions, settings);
    this.chosen(WPSHOP_CHOSEN_ATTRS);
    return this.each(function() {
      return $(this).next('.chzn-container').find(".search-field > input, .chzn-search > input").bind('keyup', function() {
        var field, msg, val;
        val = $.trim($(this).attr('value'));
        msg = val.length < options.minTermLength ? options.textTyping : options.textSearching + " '" + val + "'";
